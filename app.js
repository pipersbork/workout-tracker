            ...
            render() {
                ...
                contentEl.innerHTML = `
                    ...
                    <div class="settings-section">
                        ...
                        <div class="card-group">
                            ${['Chest', 'Back', 'Shoulders', 'Biceps', 'Triceps', 'Quads', 'Hamstrings', 'Glutes', 'Calves'].map(m => `<div class="goal-card muscle-card" data-value="${m}" role="button" tabindex="0"><h3>${m}</h3></div>`).join('')}
                        </div>
                    </div>
