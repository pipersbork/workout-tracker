    ...
    const app = {
        ...
        state: {
            ...
            settings: {
                ...
                weightIncrement: 5,
                restDuration: 60, // NEW: Default rest duration
                timerStyle: 'fullscreen' // NEW: Default timer style
            },
            allPlans: [],
            activePlanId: null, 
            editingPlanId: null,
            ...
            progressChart: null,
            volumeChart: null,
            restTimerInterval: null, // NEW: To hold the timer interval
        },
        ...
        elements: {
            ...
            restTimerOverlay: document.getElementById('rest-timer-overlay'), // NEW
            timerDisplay: document.querySelector('.timer-display'), // NEW
            timerProgress: document.querySelector('.timer-progress'), // NEW
        },
        ...
        async loadStateFromFirestore() {
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    this.state.settings = { ...this.state.settings, ...data.settings }; // Merge to keep defaults
        ...
        addEventListeners() {
            document.body.addEventListener('click', e => {
                ...
                const { action, field, value, viewName, planId, increment, theme, unit, progression, shouldSave, tab, templateId, duration, style } = target.dataset;
                ...
                const actions = {
                    ...
                    setRestTimer: () => this.setRestTimer(parseInt(duration, 10)),
                    setTimerStyle: () => this.setTimerStyle(style),
